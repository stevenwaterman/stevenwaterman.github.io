...
<BlogPost id="microbit-optimisation">
  <p>
  ...
  <figure>
    <img
      src="/assets/blog/microbit-optimisation/header.png"
      alt="Some code with cartoon fire superimposed"
      title="If your code is this hot, you need more help than I can give"
    />
  </figure>
  ...
  <Snippet config={snippets.simpleBench}/>
  ...
  <figure>
    <img
      src="/assets/blog/microbit-optimisation/testbench.png"
      title="It's no pixar, but it's mine"
      alt="My test bench shows a red pyramid on the display, and has one button for each input you can give the micro:bit, including the two buttons and the tilt gestures"
    />
  </figure>
  ...
  <ol>
    <li><a href="https://www.npmjs.com/get-npm">Install npm</a> by clicking the link and following the instructions for your operating system</li>
    <li>Install TypeScript by running <code>npm install -g typescript</code> in the command line</li>
    <li>With your code in a file named <code>myCode.ts</code>, navigate to that folder and run <code>tsc myCode.ts</code></li>
  </ol>
  ...
  <figure>
    <img
      src="/assets/blog/microbit-optimisation/performance.png"
      alt="The performance tab of developer tools is shown. It has a number of small squares for each function that ran"
      title="It's scary at first, but this is one of the most helpful things ever"
    />
  </figure>
  ...
  <p>
    I'm not going to discuss <em>how</em> to optimise your code, because it's an entire topic in itself.
    A few techniques I'd recommend looking into are:
  </p>

  <ul>
    <li><a href="https://en.wikipedia.org/wiki/Memoization">Memoization</a>: When a function is called with some arguments for the first time, the result is stored in a lookup table. On future calls, the arguments are used to get the result from the lookup table, instead of computing it again.</li>
    ...
    <li><a href="https://en.wikipedia.org/wiki/Lazy_loading">Lazy Loading</a>: Only calculate things when you're absolutely sure the result will get used. This is a good general principle to look out for in any project, and helps reduce wasted CPU time.</li>
  </ul>
  ...
  <figure>
    <img
      src="/assets/blog/microbit-optimisation/memory.png"
      alt="Shows the memory tab in developer tools. There is a big list of different places that memory was allocated."
      title="Click an entry in the list to see more information about what is being saved in memory"
    />
  </figure>
  ...
  <Snippet config={snippets.highMemory}/>
  ...
  <p>
    If you're interested in reading more about how profilers can be used to optimise code, check out one of my older blog posts <a href="/minesweeper-optimisation">Slow Code HATES him! Optimising a web app from 1 to 60fps</a>.
  </p>
</BlogPost>
