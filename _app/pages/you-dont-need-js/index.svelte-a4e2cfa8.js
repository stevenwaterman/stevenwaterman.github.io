import{S as K,i as Z,s as ee,e as i,g as a,t as x,a as r,c as t,E as n,F as w,f as o,a8 as q,H as g,b as X,q as C,r as $,m as M,k as T,w as I}from"../../chunks/vendor-2cc2f6d5.js";import{B as yo}from"../../chunks/BlogPost-94184357.js";import{S as re}from"../../chunks/Snippet-9204c8be.js";import"../../chunks/Template-c3ef261e.js";function bo(m){let l,d,u,c,h,b,v,f,p,y,_,te,S,j,W,H;return{c(){l=i("div"),d=i("h3"),d.textContent="FAQ",u=a(),c=i("details"),c.innerHTML=`<summary class="svelte-51qud7">Why is it called an accordion menu?</summary> 
    <hr/> 
    ...
    <p>Huh.</p>`,v=a(),f=i("details"),p=i("summary"),p.textContent="If I use an accordion menu will it make me cool?",y=a(),_=i("hr"),te=a(),S=i("p"),j=x(`No, not unless you're designing a MySpace profile.
      ...
      I'm using it on this page right below here, to show the code for each example!`),r(c,"class","svelte-51qud7"),r(b,"class","svelte-51qud7"),r(p,"class","svelte-51qud7"),r(f,"class","svelte-51qud7"),r(l,"class","container svelte-51qud7")},m(A,ue){t(A,l,ue),n(l,d),n(l,u),n(l,c),n(l,h),n(l,b),n(l,v),n(l,f),n(f,p),n(f,y),n(f,_),n(f,te),n(f,S),n(S,j),n(S,W),n(S,H)},p:w,i:w,o:w,d(A){A&&o(l)}}}class vo extends K{constructor(l){super();Z(this,l,null,bo,ee,{})}}function wo(m){let l,d,u,c,h,b,v,f;return{c(){l=q("svg"),d=q("path"),u=q("path"),c=q("path"),h=q("path"),b=q("path"),v=q("path"),f=q("circle"),r(d,"class","flight svelte-qssmf5"),r(d,"d","M 0 100 C 35 92 49 76 50 50"),g(d,"forceAnimation",m[0]),r(u,"class","trail svelte-qssmf5"),r(u,"d","M 50 50 C 41 23 26 23 1 41"),X(u,"stroke","yellowgreen"),g(u,"forceAnimation",m[0]),r(c,"class","trail svelte-qssmf5"),r(c,"d","M 50 50 C 30 43 14 51 0 100"),X(c,"stroke","turquoise"),g(c,"forceAnimation",m[0]),r(h,"class","trail svelte-qssmf5"),r(h,"d","M 50 50 C 84 46 96 63 100 85"),X(h,"stroke","goldenrod"),g(h,"forceAnimation",m[0]),r(b,"class","trail svelte-qssmf5"),r(b,"d","M 50 50 C 71 31 95 43 100 63"),X(b,"stroke","mediumorchid"),g(b,"forceAnimation",m[0]),r(v,"class","trail svelte-qssmf5"),r(v,"d","M 50 50 C 61 -6 76 3 73 100"),X(v,"stroke","firebrick"),g(v,"forceAnimation",m[0]),r(f,"class","explosion svelte-qssmf5"),r(f,"cx","50"),r(f,"cy","50"),r(f,"r","20"),g(f,"forceAnimation",m[0]),r(l,"viewBox","0 0 100 100"),r(l,"class","svelte-qssmf5")},m(p,y){t(p,l,y),n(l,d),n(l,u),n(l,c),n(l,h),n(l,b),n(l,v),n(l,f)},p(p,[y]){y&1&&g(d,"forceAnimation",p[0]),y&1&&g(u,"forceAnimation",p[0]),y&1&&g(c,"forceAnimation",p[0]),y&1&&g(h,"forceAnimation",p[0]),y&1&&g(b,"forceAnimation",p[0]),y&1&&g(v,"forceAnimation",p[0]),y&1&&g(f,"forceAnimation",p[0])},i:w,o:w,d(p){p&&o(l)}}}function ko(m,l,d){let{forceAnimation:u=!1}=l;return m.$$set=c=>{"forceAnimation"in c&&d(0,u=c.forceAnimation)},[u]}class ho extends K{constructor(l){super();Z(this,l,ko,wo,ee,{forceAnimation:0})}}function go(m){let l;return{c(){l=i("div"),l.innerHTML=`<input class="lightOverride svelte-1nf9t5b" id="lightModeCheckbox" type="checkbox"/> 
  ...
  <div class="body svelte-1nf9t5b"><h3 class="title svelte-1nf9t5b">My Website</h3> 
    ...
    <p>This is my website where I put my text.
      I hope you like it.
      I have now used up my entire text budget and I have none left, goodbye.</p></div>`,r(l,"class","container svelte-1nf9t5b")},m(d,u){t(d,l,u)},p:w,i:w,o:w,d(d){d&&o(l)}}}class xo extends K{constructor(l){super();Z(this,l,null,go,ee,{})}}function So(m){let l;return{c(){l=i("div"),l.innerHTML=`<nav class="svelte-10kanva"><a href="." class="svelte-10kanva">Option 1</a> 
  ...
  <p class="svelte-10kanva">(or use tab)</p>`,r(l,"class","container svelte-10kanva")},m(d,u){t(d,l,u)},p:w,i:w,o:w,d(d){d&&o(l)}}}class Co extends K{constructor(l){super();Z(this,l,null,So,ee,{})}}function $o(m){let l;return{c(){l=i("div"),l.innerHTML=`<p class="svelte-1k98kr7">Scroll down the page</p> 
...
`};var de={animation:To,sidebar:Io,stickyPositioning:_o,accordion:Ho,darkMode:Ao};function Lo(m){let l,d,u,c,h,b,v,f,p,y,_,te,S,j,W,H,A,ue,O,Bt,oe,pe,Et,P,Ke,ce,Ze,me,et,fe,tt,he,ot,ye,st,be,it,z,U,Qt,se,ve,Rt,F,lt,we,nt,ke,at,ge,rt,ie,dt,xe,ut,Se,pt,Ce,ct,$e,mt,J,Y,Xt,le,Me,Kt,D,ft,Te,ht,Ie,yt,_e,bt,He,vt,Ae,wt,G,Zt,kt,eo,gt,N,V,to,ne,Le,oo,B,xt,L,so,qe,io,St,lo,Ct,je,$t,We,Mt,Oe,Tt,Pe,It,ze,_t,E,Q,no,ae,Ue,ao,R,Ht,Fe,At,k,ro,Lt,uo,qt,po,jt,co,Wt,mo,Ot,fo,Pt,Je,zt,Ye,Ut,De,Ft,Ge,Jt,Ne,Yt,Ve,Dt,Be,Gt,Ee,Nt,Qe,Vt,Re,Xe;return _=new ho({}),O=new ho({props:{forceAnimation:!0}}),P=new re({props:{config:de.animation}}),U=new Co({}),F=new re({props:{config:de.sidebar}}),Y=new Mo({}),D=new re({props:{config:de.stickyPositioning}}),V=new vo({}),B=new re({props:{config:de.accordion}}),Q=new xo({}),R=new re({props:{config:de.darkMode}}),{c(){l=i("p"),l.innerHTML=`Every day, I see people use Javascript to do things that are supported by default in good old HTML &amp; CSS.
    ...
    Instead, I'm just going to focus on simple techniques and overlooked features - things you could easily incorporate into your own sites.`,c=a(),h=i("h2"),h.textContent="1. Animating SVGs",b=a(),v=i("p"),v.innerHTML=`You probably know that you can animate HTML elements with CSS.
    ...
    If that&#39;s you, skip to the next section.`,ct=a(),$e=i("p"),$e.textContent=`Some of you have no idea what I'm talking about, and are feeling pretty self-concious.
    When you want an HTML element to move down the page as you scroll, you can do that with plain CSS!
    Not only that, it actually works way better than a Javascript version:`,mt=a(),J=i("figure"),C(Y.$$.fragment),Xt=a(),le=i("details"),Me=i("summary"),Me.textContent="Show the code",Kt=a(),C(D.$$.fragment),ft=a(),Te=i("p"),Te.textContent=`Notice how when you scroll down, the blue square is always in exactly the same position.
    ...
    A CSS rule like `),jt=i("code"),jt.textContent="p ~ a",co=x(" applies to all "),Wt=i("code"),Wt.textContent="<a>",mo=x(" elements that have a "),Ot=i("code"),Ot.textContent="<p>",fo=x(" element sibling before them in the HTML document."),Pt=a(),Je=i("p"),Je.innerHTML=`The actual rule used is <code>#checkboxId:checked ~ .body</code> - which applies some styles to the body class <em>only</em> when the checkbox is checked.
    ...
    Instead, it's to give you some pointers towards the more useful parts of the language, and encourage you to explore what the more basic parts of web dev have on offer.`,Vt=a(),Re=i("p"),Re.innerHTML='<a href="mailto:blog@stevenwaterman.uk.com">Send me a message</a> if you make something cool!',r(y,"class","animation svelte-pfjexc"),r(j,"class","animationWarning svelte-pfjexc"),r(A,"class","svelte-pfjexc"),r(S,"class","noAnimation svelte-pfjexc"),r(pe,"class","svelte-pfjexc"),r(ve,"class","svelte-pfjexc"),X(ie,"font-size","0.7em"),r(Me,"class","svelte-pfjexc"),r(Le,"class","svelte-pfjexc"),r(qe,"href","https://www.nngroup.com/articles/accordions-complex-content/"),r(Ue,"class","svelte-pfjexc")},m(e,s){t(e,l,s),t(e,d,s),t(e,u,s),t(e,c,s),t(e,h,s),t(e,b,s),t(e,v,s),t(e,f,s),t(e,p,s),n(p,y),$(_,y,null),n(p,te),n(p,S),n(S,j),n(S,W),n(S,H),n(H,A),n(H,ue),$(O,H,null),n(p,Bt),n(p,oe),n(oe,pe),n(oe,Et),$(P,oe,null),t(e,Ke,s),t(e,ce,s),t(e,Ze,s),t(e,me,s),t(e,et,s),t(e,fe,s),t(e,tt,s),t(e,he,s),t(e,ot,s),t(e,ye,s),t(e,st,s),t(e,be,s),t(e,it,s),t(e,z,s),$(U,z,null),n(z,Qt),n(z,se),n(se,ve),n(se,Rt),$(F,se,null),t(e,lt,s),t(e,we,s),t(e,nt,s),t(e,ke,s),t(e,at,s),t(e,ge,s),t(e,rt,s),t(e,ie,s),t(e,dt,s),t(e,xe,s),t(e,ut,s),t(e,Se,s),t(e,pt,s),t(e,Ce,s),t(e,ct,s),t(e,$e,s),t(e,mt,s),t(e,J,s),$(Y,J,null),n(J,Xt),n(J,le),n(le,Me),n(le,Kt),$(D,le,null),t(e,ft,s),t(e,Te,s),t(e,ht,s),t(e,Ie,s),t(e,yt,s),t(e,_e,s),t(e,bt,s),t(e,He,s),t(e,vt,s),t(e,Ae,s),t(e,wt,s),t(e,G,s),n(G,Zt),n(G,kt),n(G,eo),t(e,gt,s),t(e,N,s),$(V,N,null),n(N,to),n(N,ne),n(ne,Le),n(ne,oo),$(B,ne,null),t(e,xt,s),t(e,L,s),n(L,so),n(L,qe),n(L,io),n(L,St),n(L,lo),t(e,Ct,s),t(e,je,s),t(e,$t,s),t(e,We,s),t(e,Mt,s),t(e,Oe,s),t(e,Tt,s),t(e,Pe,s),t(e,It,s),t(e,ze,s),t(e,_t,s),t(e,E,s),$(Q,E,null),n(E,no),n(E,ae),n(ae,Ue),n(ae,ao),$(R,ae,null),t(e,Ht,s),t(e,Fe,s),t(e,At,s),t(e,k,s),n(k,ro),n(k,Lt),n(k,uo),n(k,qt),n(k,po),n(k,jt),n(k,co),n(k,Wt),n(k,mo),n(k,Ot),n(k,fo),t(e,Pt,s),t(e,Je,s),t(e,zt,s),t(e,Ye,s),t(e,Ut,s),t(e,De,s),t(e,Ft,s),t(e,Ge,s),t(e,Jt,s),t(e,Ne,s),t(e,Yt,s),t(e,Ve,s),t(e,Dt,s),t(e,Be,s),t(e,Gt,s),t(e,Ee,s),t(e,Nt,s),t(e,Qe,s),t(e,Vt,s),t(e,Re,s),Xe=!0},p:w,i(e){Xe||(M(_.$$.fragment,e),M(O.$$.fragment,e),M(P.$$.fragment,e),M(U.$$.fragment,e),M(F.$$.fragment,e),M(Y.$$.fragment,e),M(D.$$.fragment,e),M(V.$$.fragment,e),M(B.$$.fragment,e),M(Q.$$.fragment,e),M(R.$$.fragment,e),Xe=!0)},o(e){T(_.$$.fragment,e),T(O.$$.fragment,e),T(P.$$.fragment,e),T(U.$$.fragment,e),T(F.$$.fragment,e),T(Y.$$.fragment,e),T(D.$$.fragment,e),T(V.$$.fragment,e),T(B.$$.fragment,e),T(Q.$$.fragment,e),T(R.$$.fragment,e),Xe=!1},d(e){e&&o(l),e&&o(d),e&&o(u),e&&o(c),e&&o(h),e&&o(b),e&&o(v),e&&o(f),e&&o(p),I(_),I(O),I(P),e&&o(Ke),e&&o(ce),e&&o(Ze),e&&o(me),e&&o(et),e&&o(fe),e&&o(tt),e&&o(he),e&&o(ot),e&&o(ye),e&&o(st),e&&o(be),e&&o(it),e&&o(z),I(U),I(F),e&&o(lt),e&&o(we),e&&o(nt),e&&o(ke),e&&o(at),e&&o(ge),e&&o(rt),e&&o(ie),e&&o(dt),e&&o(xe),e&&o(ut),e&&o(Se),e&&o(pt),e&&o(Ce),e&&o(ct),e&&o($e),e&&o(mt),e&&o(J),I(Y),I(D),e&&o(ft),e&&o(Te),e&&o(ht),e&&o(Ie),e&&o(yt),e&&o(_e),e&&o(bt),e&&o(He),e&&o(vt),e&&o(Ae),e&&o(wt),e&&o(G),e&&o(gt),e&&o(N),I(V),I(B),e&&o(xt),e&&o(L),e&&o(Ct),e&&o(je),e&&o($t),e&&o(We),e&&o(Mt),e&&o(Oe),e&&o(Tt),e&&o(Pe),e&&o(It),e&&o(ze),e&&o(_t),e&&o(E),I(Q),I(R),e&&o(Ht),e&&o(Fe),e&&o(At),e&&o(k),e&&o(Pt),e&&o(Je),e&&o(zt),e&&o(Ye),e&&o(Ut),e&&o(De),e&&o(Ft),e&&o(Ge),e&&o(Jt),e&&o(Ne),e&&o(Yt),e&&o(Ve),e&&o(Dt),e&&o(Be),e&&o(Gt),e&&o(Ee),e&&o(Nt),e&&o(Qe),e&&o(Vt),e&&o(Re)}}}function qo(m){let l;return{c(){l=i("details"),l.innerHTML=`<summary class="svelte-pfjexc">This post has been updated. Expand for more details.</summary> 
    ...
    <p>You can also see the full <a href="https://github.com/stevenwaterman/Lexoral/commits/stage/frontend/landing/src/routes/blog/you-dont-need-js/index.svelte">commit history</a> for this post.</p>`,r(l,"class","updates svelte-pfjexc"),r(l,"slot","updates")},m(d,u){t(d,l,u)},d(d){d&&o(l)}}}function jo(m){let l,d;return l=new yo({props:{id:"you-dont-need-js",$$slots:{updates:[qo],default:[Lo]},$$scope:{ctx:m}}}),{c(){C(l.$$.fragment)},m(u,c){$(l,u,c),d=!0},p(u,[c]){const h={};c&1&&(h.$$scope={dirty:c,ctx:u}),l.$set(h)},i(u){d||(M(l.$$.fragment,u),d=!0)},o(u){T(l.$$.fragment,u),d=!1},d(u){I(l,u)}}}class Uo extends K{constructor(l){super();Z(this,l,null,jo,ee,{})}}export{Uo as default};
