...
![The documentation for getCost() on a DTO class is automatically copied from the Cost interface](/assets/img/posts/20200103/documentation.png "Documentation for getCost()")
